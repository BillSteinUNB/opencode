export const dict = {
  ...
  "dialog.server.switch.title": "Switch server",
  "dialog.server.switch.description": "Choose the server WhisperCode should use right now.",
  ...
  "connection.error.title": "Can't connect to server",
  "connection.error.description": "WhisperCode couldn't reach the active OpenCode server.",
  "connection.error.current": "Current server",
  "connection.error.summary": "Error summary",
  "connection.error.summary.value": "The active server did not respond to the latest connection check.",
  "connection.error.next": "What to do next",
  "connection.error.next.retry": "Retry if your server is starting up or just restarted.",
  "connection.error.next.switch": "Switch or edit the server if this address is wrong.",
  "connection.error.next.add": "Add a new server if you want to connect to another machine.",
  "connection.error.action.retry": "Retry",
  "connection.error.action.switch": "Switch server",
  "connection.error.action.add": "Add new server",
  "connection.error.action.edit": "Edit server",
  "connection.error.help.prefix": "If your phone can't find your machine, make sure the server is running with",
  ...
  "quickCommit.dialog.title": "Quick Commit & Push",
  "quickCommit.dialog.branch": "Branch",
  "quickCommit.dialog.files": "Pending changes",
  "quickCommit.dialog.loading": "Checking changes...",
  "quickCommit.dialog.filesCount": "{{count}} files will be committed and pushed",
  "quickCommit.dialog.filesMore": "+{{count}} more",
  "quickCommit.dialog.action": "Commit & push",
  "quickCommit.form.message.label": "Commit message",
  "quickCommit.form.message.placeholder": "Describe this change",
  "quickCommit.form.message.required": "Enter a commit message",
  "quickCommit.form.files.empty": "No local changes are ready to commit",
  "quickCommit.button.idle": "Commit",
  "quickCommit.button.staging": "Staging",
  "quickCommit.button.committing": "Committing",
  "quickCommit.button.pushing": "Pushing",
  "quickCommit.button.success": "Pushed",
  "quickCommit.button.retry": "Retry push",
  "quickCommit.branch.unknown": "current branch",
  "quickCommit.toast.started.title": "Commit & push started",
  "quickCommit.toast.started.description": "You can keep using the app while Git runs in the background.",
  "quickCommit.toast.success.title": "Changes pushed",
  "quickCommit.toast.success.description": "Committed and pushed to {{branch}}.",
  "quickCommit.toast.failed.title": "Commit & push failed",
  "quickCommit.toast.failed.description": "Git returned an error before the push completed.",
  "quickCommit.toast.noChanges.title": "No changes to commit",
  "quickCommit.toast.noChanges.description": "There aren't any local changes to commit right now.",
  "quickCommit.toast.identity.title": "Git identity required",
  "quickCommit.toast.identity.description": "Configure your Git name and email before committing from mobile.",
  "quickCommit.toast.auth.title": "Git auth failed",
  "quickCommit.toast.auth.description": "Check your Git remote credentials, then try the push again.",
  "quickCommit.toast.pushRejected.title": "Push was rejected",
  "quickCommit.toast.pushRejected.description": "Pull or rebase the branch first, then retry the push.",
  "quickCommit.toast.network.title": "Network error while pushing",
  "quickCommit.toast.network.description": "Check connectivity to your Git remote, then try again.",
